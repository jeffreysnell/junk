...
class Player {
    constructor() {
        ...
        this.routine = [] //[(warrior)=> warrior.walk('backward'), (warrior)=> warrior.rescue('backward')]
    }

    playTurn(warrior) {

        if(this.routine.length){
            this.routine.shift()(warrior);
            return;
        }
        ...
        this.decideOn(FIGHT, !!nextUnitSpace && nextUnitSpace.getUnit() && nextUnitSpace.getUnit().isEnemy());
